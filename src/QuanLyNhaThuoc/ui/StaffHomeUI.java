...
public class StaffHomeUI extends JFrame {
    public StaffHomeUI(String tenDangNhap, String hoTen, String ngaySinh, String sdt, String email, String role) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            new StaffHomeUI("admin", "Admin User", "01/01/1990", "1234567890", "admin@example.com", "nhanvien").setVisible(true);
        });
    }
}